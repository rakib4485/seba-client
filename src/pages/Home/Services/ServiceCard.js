  ...
  return (
    <div className="relative mb-32">
      ...
      <div className="bg-[#F4F3F2] p-5 w-[80%] absolute -bottom-28 text-center">
        ...
        <p className='text-[#906555] border-2 border-[#F4F3F2] border-b-[#906555] p-2 hover:text-white hover:bg-[#906555] hover:border-[#906555] w-[125px] mx-auto duration-500 '><Link>আরও পড়ুন</Link></p>
